...
TEST_CASES = [
    ...
    ("What's new in tech world",        ("SEARCH", "FALLBACK")),
    ("What's new in fashion world",     ("SEARCH", "FALLBACK")),
    ("Current Python version",          ("SEARCH", "FALLBACK")),
    ("Weather in Tunis",                ("SEARCH", "FALLBACK")),
